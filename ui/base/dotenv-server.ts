...
export const ETHERSCAN_URL = env.get('ETHERSCAN_URL').asUrlString()
export const OPENSEA_URL = env.get('OPENSEA_URL').asUrlString()
export const TWITTER_URL = env.get('TWITTER_URL').asUrlString()
export const DISCORD_URL = env.get('DISCORD_URL').asUrlString()
